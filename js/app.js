...
(function() {
  ...
  window.App = (function() {
    ...
    function App() {
      ...
      this.setSmallScale = __bind(this.setSmallScale, this);
      ...
      this.updateColours = __bind(this.updateColours, this);
      this.canvas = $('#big');
      this.small = $('#small');
      ...
      $('#redCount').keyup(this.updateColours);
      $('#greenCount').keyup(this.updateColours);
      $('#blueCount').keyup(this.updateColours);
    }

    App.prototype.updateColours = function(event) {
      var blue, green, red;
      if ($(event.currentTarget).attr('type') === 'text') {
        red = $('#redCount').val();
    ...
    App.prototype.setCanvasScale = function() {
      ...
      return this.ctx.fillRect(0, 0, this.canvas[0].width, this.canvas[0].height);
    };

    App.prototype.setSmallScale = function() {
      this.small.css({
    ...
    App.prototype.mouseOn = function(event) {
      this.isDown = true;
